...
<div id="sponsor-bar" class="image_carousel">	
	<ul id="foo3">
	  ...
	  <li style="width: 139px; margin-right: 0px;"><a href="http://www.WQMobile.com/" target="_blank"><img src="http://beijing.thegmic.com/wp-content/uploads/sponsors/wqmobile.png" height="57" style="border: 1px solid #B6B6B6; padding: 0px;"></a></li>
