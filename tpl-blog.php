...
<?php $bg = "";
	  ...
	  $general_settings = get_post_meta($post->ID,'_tpl_blog_settings',TRUE);
...
<article class="content <?php echo $bg;?>" <?php echo $custom_style.$anchor_colors;?>>
	<div class="pattern" <?php echo $pattern;?>>
    	<div class="container">
        	<?php get_blog_page_content($post->ID,true);?>
        </div>
    </div>
