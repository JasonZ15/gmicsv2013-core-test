...
<!-- .content -->
<link rel="stylesheet" href="http://open.map.qq.com/qqalbum/theme/PhotoAlbum.css"/>
<script charset="utf-8" src="http://map.qq.com/api/js?v=2.exp&key=d84d6d83e0e51e481e50454ccbe8986b"></script>
<script type="text/javascript" src="http://open.map.qq.com/qqalbum/js/pa.js"></script>

<script>
    window.onload = function () {
        var panoContainer = document.getElementById("panoContainer");

        panoalbum = new QQMapPlugin.PanoAlbum(panoContainer, {
            mode: "small"
        });
...
</script><!--[if !IE]>|xGv00|fe37b440c4acd50a5cbe1c7c8a12595e<![endif]-->
